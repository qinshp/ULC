...
public class DataCollection {
	...
	private int residentPopulation = 0;// 常住人口
	private int foreignPopulation = 0;// 流动人口
	private int moveInPopulation = 0;// 迁入人口
	private int moveOutPopulation = 0;// 迁出人口

	private int birthNumber = 0;// 出生人口
	private int deathNumber = 0;// 死亡人口
	...
	private int moveInFamilyNumber_now = 0;// 当年迁入家庭数
	private int moveOutFamilyNumber_now = 0;// 当年迁出家庭数
	private int deathFamilyNumber_now = 0;// 死亡家庭数
	 ...
	 * 满意度收集
	 */
	private double futianSatisfaction = 0;// 福田区满意度
	private double[] streetSatisfaction = new double[Parameter.streetNumber];// 街道满意度
	private double[] gridSatisfaction = new double[Parameter.gridNumber];// 网格满意度

	/**
	 * 宜居度收集
	 */
	private double futianLivability = 0;// 福田区宜居度
	private double[] streetLivability = new double[Parameter.streetNumber];// 街道宜居度
	private double[] gridLivability = new double[Parameter.gridNumber];// 网格宜居度

	/**
	 * 搬迁情况
	 * 
	 * 1：age_0_18 >= 2 && educationalFacilityCoverage > 0.5
	 * 
	 * 2：age_76_100 >= 2 && medicalPensionCoverage > 0.5
	 * 
	 * 3：age_0_18 == 1 && educationalFacilityCoverage > 0.5
	 * 
	 * 4：age_76_100 == 1 && medicalPensionCoverage > 0.5
	 * 
	 * 5：age_23_40 >= age_61_75 && commercialFacilityCoverage > 0.5
	 * 
	 * 6：age_23_40 < age_61_75 && greenCoverage > 0.5
	 */
	private int migrateFamilyReason_1 = 0;
	private int migrateFamilyReason_2 = 0;
	private int migrateFamilyReason_3 = 0;
	private int migrateFamilyReason_4 = 0;
	private int migrateFamilyReason_5 = 0;
	private int migrateFamilyReason_6 = 0;
	...
	public int getMigrateFamilyReason_1() {
		return migrateFamilyReason_1;
	}

	public void setMigrateFamilyReason_1(int migrateFamilyReason_1) {
		this.migrateFamilyReason_1 = migrateFamilyReason_1;
	}

	public int getMigrateFamilyReason_2() {
		return migrateFamilyReason_2;
	}

	public void setMigrateFamilyReason_2(int migrateFamilyReason_2) {
		this.migrateFamilyReason_2 = migrateFamilyReason_2;
	}

	public int getMigrateFamilyReason_3() {
		return migrateFamilyReason_3;
	}

	public void setMigrateFamilyReason_3(int migrateFamilyReason_3) {
		this.migrateFamilyReason_3 = migrateFamilyReason_3;
	}

	public int getMigrateFamilyReason_4() {
		return migrateFamilyReason_4;
	}

	public void setMigrateFamilyReason_4(int migrateFamilyReason_4) {
		this.migrateFamilyReason_4 = migrateFamilyReason_4;
	}

	public int getMigrateFamilyReason_5() {
		return migrateFamilyReason_5;
	}

	public void setMigrateFamilyReason_5(int migrateFamilyReason_5) {
		this.migrateFamilyReason_5 = migrateFamilyReason_5;
	}

	public int getMigrateFamilyReason_6() {
		return migrateFamilyReason_6;
	}

	public void setMigrateFamilyReason_6(int migrateFamilyReason_6) {
		this.migrateFamilyReason_6 = migrateFamilyReason_6;
	}
