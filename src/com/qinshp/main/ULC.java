...
import com.qinshp.agent.Cell;
import com.qinshp.controller.DataCollection;
import com.qinshp.controller.DataStorage;
import com.qinshp.controller.Parameter;
import com.qinshp.controller.Raster;
import com.qinshp.excel.Excel;
import com.qinshp.tool.BackgroundPicture;
import com.qinshp.tool.Point;
import com.qinshp.tool.ReadTxt;
...
/**
 * urban livability change ULC
 */
public class ULC implements ContextBuilder<Object> {

	private static String propertiesFileName = "/ULC.properties";
	...
	public Context<Object> build(Context<Object> context) {
		...
		double employmentRate = (double) parameters.getValue("employmentRate");
		double unemploymentRate = (double) parameters.getValue("unemploymentRate");
		double moveDesireLimitRateMin = (double) parameters.getValue("moveDesireLimitRateMin");
		double moveInPopulationLimitRate = (double) parameters.getValue("moveInPopulationLimitRate");
		double foreignResidentGrowthRate_up = (double) parameters.getValue("foreignResidentGrowthRate_up");
		double foreignResidentGrowthRate_down = (double) parameters.getValue("foreignResidentGrowthRate_down");
		double moveIncomeLimitMin = (double) parameters.getValue("moveIncomeLimitMin");
		double fertilityPolicy = (double) parameters.getValue("fertilityPolicy");
		double governmentToFacilityCoverageChange_up = (double) parameters
				.getValue("governmentToFacilityCoverageChange_up");
		double governmentToFacilityCoverageChange_down = (double) parameters
				.getValue("governmentToFacilityCoverageChange_down");
		context.add(new Parameter(moveInPopulationLimitRate, unemploymentRate, employmentRate, moveDesireLimitRateMin,
				foreignResidentGrowthRate_up, foreignResidentGrowthRate_down, moveIncomeLimitMin, fertilityPolicy,
				governmentToFacilityCoverageChange_up, governmentToFacilityCoverageChange_down, MAP_X, MAP_Y));
	...
	public void step() throws Exception {
		...
		moveInFamilyNumberData.WriteArcgisRasterData("./output/迁入家庭数" + Parameter.year + ".txt", "double");
		moveOutFamilyNumberData.WriteArcgisRasterData("./output/迁出家庭数" + Parameter.year + ".txt", "double");
